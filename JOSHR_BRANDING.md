# JOSHR branding — mergify/bp/version-16-hotfix/pr-4739

## Compatibility

Branding base: `99a3176a24e4deb2adfc2a680f86fae348fea717`. HRMS version: **16.10.0**. This change preserves this branch's existing business logic, dependencies, migrations and app routes. It does not upgrade or downgrade HRMS. Use a matching Frappe/ERPNext release; a development or backport branch is not automatically suitable for production.
