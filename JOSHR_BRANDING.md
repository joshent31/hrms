# JOSHR branding — mergify/bp/version-16-hotfix/pr-4567

## Compatibility

Branding base: `80eeaf8dee11a7b01e9aa65c021fb68db247140d`. HRMS version: **16.7.0**. This change preserves this branch's existing business logic, dependencies, migrations and app routes. It does not upgrade or downgrade HRMS. Use a matching Frappe/ERPNext release; a development or backport branch is not automatically suitable for production.
