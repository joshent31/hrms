# JOSHR branding — version-16

## Compatibility

Branding base: `a4768b441cff346def505e27f2a2229ee1e05b9b`. HRMS version: **16.18.1**. This change preserves this branch's existing business logic, dependencies, migrations and app routes. It does not upgrade or downgrade HRMS. Use a matching Frappe/ERPNext release; a development or backport branch is not automatically suitable for production.
