# JOSHR branding — version-16-hotfix

## Compatibility

Branding base: `89c921241eaeaa358e68f432290e1f87f8fce410`. HRMS version: **16.17.1**. This change preserves this branch's existing business logic, dependencies, migrations and app routes. It does not upgrade or downgrade HRMS. Use a matching Frappe/ERPNext release; a development or backport branch is not automatically suitable for production.
