# JOSHR branding — mergify/bp/version-15-hotfix/pr-4678

## Compatibility

Branding base: `ffa596ff5051fbb7a79830c0d054ef82d6cd5809`. HRMS version: **15.60.2**. This change preserves this branch's existing business logic, dependencies, migrations and app routes. It does not upgrade or downgrade HRMS. Use a matching Frappe/ERPNext release; a development or backport branch is not automatically suitable for production.
