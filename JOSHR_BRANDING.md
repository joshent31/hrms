# JOSHR branding — mergify/bp/version-16-hotfix/pr-5252

## Compatibility

Branding base: `51216a6fed411f73c359c40bfd22269f42cd327e`. HRMS version: **16.17.1**. This change preserves this branch's existing business logic, dependencies, migrations and app routes. It does not upgrade or downgrade HRMS. Use a matching Frappe/ERPNext release; a development or backport branch is not automatically suitable for production.
