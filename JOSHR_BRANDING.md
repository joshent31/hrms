# JOSHR branding — mergify/bp/version-15-hotfix/pr-4276

## Compatibility

Branding base: `df783705c3dc9e4eadb86b7521eef0bd359eb654`. HRMS version: **15.33.2**. This change preserves this branch's existing business logic, dependencies, migrations and app routes. It does not upgrade or downgrade HRMS. Use a matching Frappe/ERPNext release; a development or backport branch is not automatically suitable for production.
