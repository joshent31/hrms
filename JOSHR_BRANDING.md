# JOSHR branding — mergify/bp/version-16-hotfix/pr-5047

## Compatibility

Branding base: `466b712491e063b7abcde2a5be6117c4ede7c897`. HRMS version: **16.14.0**. This change preserves this branch's existing business logic, dependencies, migrations and app routes. It does not upgrade or downgrade HRMS. Use a matching Frappe/ERPNext release; a development or backport branch is not automatically suitable for production.
