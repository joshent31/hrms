# JOSHR branding — revert-4141-fix/holiday-check-for-half-day

## Compatibility

Branding base: `e00fce200b9389c6088b3b6c3906b54668219b52`. HRMS version: **17.0.0-dev**. This change preserves this branch's existing business logic, dependencies, migrations and app routes. It does not upgrade or downgrade HRMS. Use a matching Frappe/ERPNext release; a development or backport branch is not automatically suitable for production.
