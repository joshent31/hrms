# JOSHR branding — version-14

## Compatibility

Branding base: `0bfc80f0ec64a034359307290575b0e1d040ad09`. HRMS version: **14.38.1**. This change preserves this branch's existing business logic, dependencies, migrations and app routes. It does not upgrade or downgrade HRMS. Use a matching Frappe/ERPNext release; a development or backport branch is not automatically suitable for production.
